          ...
          <Tabs syncKey="unixGpuType">
            ...
            <TabItem label="Linux + AMD GPU">
              ...
              :::caution[ROCm and torch 2.12]
                ...
                ```sh
                uv pip install <PACKAGE_SPECIFIER>==<VERSION> "torch<2.12" --python 3.14 --python-preference only-managed --torch-backend=rocm7.1 --force-reinstall
                ```
  ...
  8. Install the `invokeai` package. Substitute the package specifier and version.
      ...
      <Tabs synckKey="torchBackend">
        <TabItem label="No torch backend">
          ```sh
          uv pip install <PACKAGE_SPECIFIER>==<VERSION> --python 3.14 --python-preference only-managed --force-reinstall
          ```
        </TabItem>
        <TabItem label="With torch backend">
          ```sh
          uv pip install <PACKAGE_SPECIFIER>==<VERSION> --python 3.14 --python-preference only-managed --torch-backend=<VERSION> --force-reinstall
          ```
        </TabItem>
