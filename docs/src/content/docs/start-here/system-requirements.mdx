...
| Z-Image Base | 1024x1024 | Nvidia 20xx+ | 8GB | 16GB | Q4_K 8GB; Q8/BF16 16GB+ |
...
| Anima | 1024x1024 | Nvidia 20xx+ | 8GB | 16GB | Supports newer Anima fine-tunes |
| Qwen Image 2.1 | 1024x1024 | Nvidia 30xx+ | 12GB | 32GB | GGUF Q4_K_M ~4.6GB; needs standalone Qwen3-VL encoder |
...
| Ideogram 4 | 1024x1024 | Nvidia 20xx+ | 8GB | 16GB |  |
| ERNIE-Image | 1024x1024 | Nvidia 20xx+ | 8GB | 16GB |  |
| ERNIE-Image-Turbo | 1024x1024 | Nvidia 20xx+ | 6GB | 12GB |  |
...
Invoke requires python `3.13` for local development. Python `3.14` and `3.15` are planned but currently WIP due to missing dependency wheels.
