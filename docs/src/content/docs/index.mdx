...
<CardGrid>
  <Card title="Get Installed" icon="download">
    Ready to dive in? The [Invoke Launcher](/start-here/installation/) is the fastest way to get up and running on Windows and Linux. For advanced setups, try [Docker](/configuration/docker/) or a [manual Python installation](/start-here/manual/).
...
Ready to unleash your creativity? Invoke is available for Windows and Linux. Self-hosted, fully customizable, and Apache 2.0 licensed.
