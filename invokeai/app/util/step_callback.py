...
QWEN_IMAGE_2_1_LATENT_RGB_FACTORS = [
...
QWEN_IMAGE_2_1_LATENT_RGB_BIAS = [-0.1228, -0.1869, -0.3083]
...
def diffusion_step_callback(
    ...
    if base_model in [BaseModelType.StableDiffusion1, BaseModelType.StableDiffusion2]:
        ...
        if base_model == BaseModelType.QwenImage and sample.shape[1] == 64:
            latent_rgb_factors = QWEN_IMAGE_2_1_LATENT_RGB_FACTORS
            latent_rgb_bias = QWEN_IMAGE_2_1_LATENT_RGB_BIAS
        else:
    ...
    # Spatial downscale ratio: 8x is the SD/Wan-A14B default;
