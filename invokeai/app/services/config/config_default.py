...
class InvokeAIAppConfig(BaseSettings):
    ...
    Attributes:
        ...
        ui_mode: UI mode. `local` launches the local GUI picker and opens the web UI in a browser; `server` starts the backend without opening a browser.<br>Valid values: `local`, `server`
    """
    ...
    ui_mode:                        str = Field(default="server",           description="UI mode. `local` launches the local GUI picker and opens the web UI in a browser; `server` starts the backend without opening a browser.<br>Valid values: `local`, `server`")
