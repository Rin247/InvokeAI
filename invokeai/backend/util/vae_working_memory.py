...
def estimate_vae_working_memory_sd15(
    ...
    # element size (precision). This estimate is accurate for SD1.
...
def estimate_vae_working_memory_qwen_image(
    ...
    # The Qwen Image VAE is much heavier than the SD VAE and needs correspondingly larger
