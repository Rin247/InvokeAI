...
qwen_image_torchao_int4 = StarterModel(
    name="Qwen Image 2512 (TorchAO INT4)",
    base=BaseModelType.QwenImage,
    source="Qwen/Qwen-Image-2512",
    description="Qwen Image 2512 - TorchAO INT4 weight-only quantized transformer. Runtime quantization at load time. (~10GB)",
    type=ModelType.Main,
    format=ModelFormat.TorchAOQuantized,
    quant_type="int4_weight_only",
    group_size=128,
)

qwen_image_edit_torchao_int4 = StarterModel(
    name="Qwen Image Edit 2511 (TorchAO INT4)",
    base=BaseModelType.QwenImage,
    source="Qwen/Qwen-Image-Edit-2511",
    description="Qwen Image Edit 2511 - TorchAO INT4 weight-only quantized transformer. Runtime quantization at load time. (~10GB)",
    type=ModelType.Main,
    format=ModelFormat.TorchAOQuantized,
    variant=QwenImageVariantType.Edit,
    quant_type="int4_weight_only",
...
STARTER_MODELS: list[StarterModel] = [
    ...
    qwen_image_torchao_int4,
    qwen_image_edit_torchao_int4,
    z_image_turbo,
